...
test.describe('Verify that the user is able to sort the product', () => {
  ...
  test('User enters men\'s fashion and sort the sunglasses into price as high to low', async ({ Given, homepage, When, And, Then, sunglasspage }) => { 
